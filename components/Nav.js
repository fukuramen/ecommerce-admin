...
export default function Nav({ show }) {
  ...
  return (
    ...
    >
      {/* <div className="mb-4 mr-4"> <= md:hidden sẽ ẩn div chứa Logo khi ở giao diện desktop*/}
      <div className="mb-4 mr-4 md:hidden">
        <Logo />
      </div>
      <nav className="flex flex-col gap-2">
        ...
        <Link
          href={'/aboutus'}
          className={pathname.includes('/aboutus') ? activeLink : inactiveLink}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
